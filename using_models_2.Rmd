...
Based on the boxplot, I would say it is not necessarily different for any species in general. The median of male penguins is indeed larger, but not all the penguins. When we only make a boxplot comparing the body mass and sex, we are uncertain whether all the species are heavier than their female counterpart. Also, when you compare the boxplot between the species and body mass, you will see that the Gentoo boxplot is higher than the other two species. There are higher possibilities that when any male or female penguins compared with a Gentoo species, it would be significantly lower. It is hard to tell. It will be more apparent if we could take a further look at adding sex into the boxplot.
